...
class CreatePeneranganJasaUmumsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penerangan_jasa_umum', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('penerangan_jasa_umum');
    }
}
