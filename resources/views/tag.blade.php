                        ...
                        <div class="blog-box blog-style-1 blog-single-detail">
                            ...
                            <div class="blog-entry-meta">
                                <ul class="list-inline">
                                    <li class="blog-categories"><a
                                            href="#">{{ $post->category->name ?? "Belum ada kategori" }}</a></li>
                                    <li class="blog-date"><i class="optico-icon-clock"></i><a
                                            href="#">{{ $post->created_at->format('j F Y') }}</a></li>
                                    <li class="blog-author"><i class="optico-icon-user"></i><a
                                            href="#">{{ $post->user->name ?? "Anonim" }}</a></li>
                            ...
                            <h3 class="blog-box-title"><a
                                    href="{{ route('post.single', $post->slug) }}">{{ $post->title }}</a></h3>
                            <p></p>
                            <div class="link-btn">
                                <a class="skincolor" href="{{ route('post.single', $post->slug) }}">Selengkapnya<i
