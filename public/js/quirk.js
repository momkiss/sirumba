...
$(document).ready(function() {
  ...
  $('#todayDate').text(getDateToday());
   ...
   function getDateToday() {
     var m_names = new Array("Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September",
...
// Modal file berkas
  ...
  $('#modal-file-berkas').on('show.bs.modal', function (e) {
    var data = $(e.relatedTarget)
    var file = data.data('file')
   $(this).find('.file-berkas').attr('src', BASE_URL+'/uploads/'+file);
